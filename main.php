  ...
  <body>
    ...
    <section id="main-form">
        ...
        <div class="container w-100 bg-danger" id="formsetting">
            <h3 class="text-center text-white pb-3 pt-2 font-weight-bold">Welcome to dashboard</h3>
            <div class="row">
                <div class="col-md-4 col-sm-4 col-12 m-auto">
                ...
                <div class="col-md-4 col-sm-4 col-12 m-auto">
                    <a href="editstudent.php" class="text-white text-center"><i class="fa fa-eye"></i>
